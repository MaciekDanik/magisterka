...
\begin{figure}[htbp]
    \centering
    \subfloat[][Pełne zdjęcie źródłowe]{\includegraphics[width = 0.3\textwidth]{Pics/Dataset/przyklad_pelne_zdjecie.jpg}\label{fig:dataset_full_image}}
    \quad
    \subfloat[][Kafelek $640 \times 640$]{\includegraphics[width = 0.3\textwidth]{Pics/Dataset/przyklad_kafelek.jpg}\label{fig:dataset_tile}}
    \quad
    \subfloat[][Kafelek z~adnotacjami]{\includegraphics[width = 0.3\textwidth]{Pics/Dataset/przyklad_kafelek_adnotacje.jpg}\label{fig:dataset_tile_annotations}}
...
Zautomatyzowany proces uczenia oparty na generowaniu pseudoetykiet zrealizowano w~trybie dwuiteracyjnym, zgodnie z~następującą procedurą:
\begin{enumerate}
